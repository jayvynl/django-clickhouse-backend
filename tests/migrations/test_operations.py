...
from django.db import OperationalError, connection, migrations, models, transaction
...
class OperationTests(OperationTestBase):
    ...
    def test_create_model_with_boolean_expression_in_check_constraint(self):
        ...
        insert_sql = f"INSERT INTO {app_label}_product (id, price) VALUES"
        with connection.cursor() as cursor:
            with self.assertRaises(OperationalError):
    ...
    def test_alter_field_reloads_state_on_fk_with_to_field_target_changes(self):
        ...
        project_state = self.apply_operations(
            ...
            operations=[
                migrations.AlterField(
                    "Rider", "slug", models.TextField(unique=True, max_length=99)
                ),
                migrations.AlterField(
                    "Pony", "slug", models.TextField(unique=True, max_length=99)
                ),
            ],
        )
    ...
    def test_add_index(self):
        ...
        self.assertIndexNameNotExists("test_adin_pony", "pony_pink_idx")
        with connection.schema_editor() as editor:
            operation.database_forwards("test_adin", editor, project_state, new_state)
        self.assertIndexNameExists("test_adin_pony", "test_adin_pony_pink_idx")
        # And test reversal
        with connection.schema_editor() as editor:
            operation.database_backwards("test_adin", editor, new_state, project_state)
        self.assertIndexNameNotExists("test_adin_pony", "test_adin_pony_pink_idx")
        # And deconstruction
        definition = operation.deconstruct()
    ...
    def test_remove_index(self):
        ...
        self.assertIndexNameNotExists("test_rmin_pony", "pink_weight_idx")
        # And test reversal
        with connection.schema_editor() as editor:
        ...
        self.assertIndexNameNotExists("test_rmin_pony", "pony_test_idx")
        # And test reversal
    ...
    def test_separate_database_and_state(self):
        ...
        database_operation = migrations.RunSQL(
            "CREATE TABLE i_love_ponies (id int, special_thing int) ENGINE MergeTree ORDER BY id;",
            "DROP TABLE i_love_ponies;",
        )
        state_operation = migrations.CreateModel(
            "SomethingElse", [("id", models.BigAutoField(primary_key=True))]
        )
