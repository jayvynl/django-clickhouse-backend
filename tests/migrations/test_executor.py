...
class ExecutorTests(MigrationTestBase):
    ...
    def test_atomic_operation_in_non_atomic_migration(self):
        ...
        self.assertTrue(Editor.objects.exists())
    ...
    def test_alter_id_type_with_fk(self):
        try:
            ...
            # DB::Exception: ALTER of key column id from type Int64 to type FixedString(10) is not safe because it can change the representation of primary key.
