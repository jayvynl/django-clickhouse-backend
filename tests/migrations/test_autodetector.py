...
class AutodetectorTests(BaseAutodetectorTests):
    ...
    author_empty = ModelState(
        "testapp", "Author", [("id", models.BigAutoField(primary_key=True))]
    )
    ...
    other_stable = ModelState(
        "otherapp", "Stable", [("id", models.BigAutoField(primary_key=True))]
    )
    third_thing = ModelState(
        "thirdapp", "Thing", [("id", models.BigAutoField(primary_key=True))]
    )
    book = ModelState(
        "otherapp",
        "Book",
    ...
    aardvark = ModelState(
        "thirdapp", "Aardvark", [("id", models.BigAutoField(primary_key=True))]
    )
    aardvark_testapp = ModelState(
        "testapp", "Aardvark", [("id", models.BigAutoField(primary_key=True))]
    )
    ...
    knight = ModelState(
        "eggs", "Knight", [("id", models.BigAutoField(primary_key=True))]
    )
    rabbit = ModelState(
        "eggs",
        "Rabbit",
    ...
    def test_identical_regex_doesnt_alter(self):
        ...
        to_state = ModelState(
            "testapp",
            "model",
            [("id", models.BigAutoField(primary_key=True, validators=[validate_slug]))],
        )
    ...
    def test_empty_unique_together(self):
        ...
        model_state_not_specified = ModelState(
            "a", "model", [("id", models.BigAutoField(primary_key=True))]
        )
            ...
            book_renamed_indexes = ModelState(
                ...
                ],
                {
                    "indexes": [
                        models.Index(
                            fields=["author", "title"],
                            name="renamed_book_title_author_idx",
                        )
                    ],
                },
            )
    ...
    def test_many_to_many_changed_to_concrete_field(self):
        ...
        if compat.dj_ge41:
            ...
            self.assertOperationFieldAttributes(
                changes, "testapp", 0, 2, max_length=100
            )
        else:
            self.assertNumberMigrations(changes, "testapp", 1)
            self.assertOperationTypes(
            ...
            self.assertOperationAttributes(changes, "testapp", 0, 2, name="Publisher")
            self.assertOperationFieldAttributes(
                changes, "testapp", 0, 1, max_length=100
            )
