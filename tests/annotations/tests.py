...
from django.db.models.functions import Coalesce, Floor, Lower
...
class NonAggregateAnnotationTestCase(TestCase):
    ...
    # SELECT "annotations_company"."name", LENGTH(TRIM("annotations_company"."name")) AS "length" FROM "annotations_company"
    # DB::Exception: Functions trimLeft, trimRight and trimBoth cannot work with FixedString argument.
    ...
    def test_q_expression_annotation_with_aggregation(self):
        ...
        # No boolean type in clickhouse, boolean is Int8.
        self.assertIs(book.isnull_pubdate, 0)
        self.assertEqual(book.rating_count, 1)
    ...
    def test_distinct_on_with_annotation(self):
        ...
        # FixedString(20) length is always 20
        # Maybe CharField should be mapped to String?
        # lengths = (
    ...
    # AssertionError: Decimal('0') != Decimal('0.001')
    # That is: "salary" is Decimal(8, 2), "salary" / 10 is Decimal(8, 2) too, lose third decimal place.
    ...
    # book_contact_set__isnull=True -> book_contact_set=0
    def test_annotation_aggregate_with_m2o(self):
        qs = (
            Author.objects.filter(age__lt=30)
            .annotate(
                max_pages=Case(
                    When(book_contact_set=0, then=Value(0)),
